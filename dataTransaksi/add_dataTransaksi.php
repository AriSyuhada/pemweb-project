    ...
    <section>
        ...
        <div class="formpart">
           ...
           <div class="form-label-group">
                <form action="dataTransaksi.php?db=<?php echo $_GET['db']; ?>&add=1&booksID=<?php echo $_GET['booksID']; ?>" method="post">
                    <h5>ID TRANSAKSI:</h5>
                    <input type="text" id="idtransaksi" class="form-control text-center" placeholder="transactID" name="id" required>
                    <br>
                    <h5>JUMLAH TRANSAKSI:</h5>
                    <input type="text" id="jumlahtransaksi" class="form-control text-center" placeholder="transact" name="jumlah" required>
                    <p id="note">Beri tanda "-" untuk menandakan sebagai pengeluaran.</p>
                    <h5>KETERANGAN TRANSAKSI:</h5>
                    <input type="text" id="informasi" class="form-control text-center" placeholder="information" name="infoTransaksi" required>
                    <input type="hidden" name="add" value=1>
                    <br>
                    <button class="addbutton" id="add-button">ADD DATA</button>
                    <button onclick="location.href='dataTransaksi.php?db=<?php echo $_GET['db']; ?>&booksID=<?php echo $_GET['booksID']; ?>'" class="addbutton" id="back-button">BACK</button>
                </form>
            </div>
            </div>
        </div>
